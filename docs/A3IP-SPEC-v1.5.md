...
**Current version: v1.5** — Registry & Ecosystem. This document is the complete, self-contained specification. All versions v1.0–v1.4 are fully backward compatible with v1.5.
...
*A3IP Specification v1.5 — Complete consolidated edition*
